...
app.Run(async ctx =>
{
    ...
    if (query == "?countries")
    {
        ...
        {
            new("Соединенные Штаты Америки (США)", "Вашингтон, округ Колумбия", "Северная Америка", 331_000_000,
                "английский"),
            new("Франция", "Париж", "Европа", 67_000_000, "французский"),
            new("Китай", "Пекин", "Азия", 1_400_000_000, "китайский"),
            new("Бразилия", "Бразилиа", "Южная Америка", 213_000_000, "португальский"),
            new("Япония", "Токио", "Азия", 126_000_000, "японский")
        };
    ...
    {
        var restaurants = new List<Restaurant>(new[]
        {
